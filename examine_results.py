...
def load_data(dataset: str) -> pd.DataFrame:
    ...
    """
    dataset_file = "{}_new_wclass3.pkl".format(dataset)
...
def correlation(data: pd.DataFrame, dataset: str) -> List[Dict]:
    ...
    for y in np.unique(data['Y']):
        ...
        result = {
            ...
            "Metric": "correlation",
            "Label": y,
            "Real-Real": real_real_corr,
            "Fake-Fake": fake_fake_corr,
            "Real-Fake": real_fake_corr,
        }
...
def euclidean(data: pd.DataFrame, dataset: str) -> List[Dict]:
...
if __name__ == '__main__':
    ...
    for dataset in ["ALLAML", "colon", "GLIOMA", "leukemia", "lung_discrete", "lung",  "lymphoma", "Prostate_GE",
        ...
        all_results.extend(correlation(data, dataset))
        all_results.extend(euclidean(data, dataset))
    print("saving results")
    with open('examine_samples_wclass3.csv', 'w') as output_file:
